      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4">
            <button className="bg-yellow-7s00 text-gray-300 px-6 py-3 rounded-xl hover:bg-green-700 transition">
              Get Started
            </button>
            <Link to="/about">
              <button className="border border-yellow-600 text-gray-400 px-6 py-3 rounded-xl hover:bg-green-50 transition">
                Learn More
              </button>
            </Link>
          </div>
